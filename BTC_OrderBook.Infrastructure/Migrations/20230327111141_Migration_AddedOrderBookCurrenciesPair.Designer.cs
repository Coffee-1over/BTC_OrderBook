...
namespace BTC_OrderBook.Infrastructure.Migrations
{
    ...
    [Migration("20230327111141_Migration_AddedOrderBookCurrenciesPair")]
    partial class Migration_AddedOrderBookCurrenciesPair
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BTC_OrderBook.Domain.Entities.OrderBookEntity", b =>
                {
                    ...
                    b.Property<string>("CurreciesPair")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)")
                        .HasColumnName("CURRENCIES_PAIR");
